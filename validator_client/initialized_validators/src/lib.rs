...
use types::{Address, Graffiti, Hash256, Keypair, PublicKey, PublicKeyBytes};
    ...
    async fn from_definition(
        ...
        let signing_method = match def.signing_definition {
            ...
            SigningDefinition::DistributedKeystore {
                ...
                let mut committee =
                    DvfOperatorCommittee::from_definition(local_operator_id, committee_def, log, operator_channels).await;
