...
pub struct ValidatorClient {
    ...
    #[clap(
        long,
        value_name = "NODE_ID",
        help = "This node's id in smart contract",
        display_order = 0
    )]
    pub id: u32,
    ...
    #[clap(
        long,
        value_name = "API",
        help = "The api where the operator to send performance request",
        display_order = 0
    )]
    pub api: String,
    ...
    #[clap(
        ...
        help = "This is the address of registry contract",
        display_order = 0
    )]
    ...
    #[clap(
        ...
        help = "This is the address of network contract",
        display_order = 0
    )]
    ...
    #[clap(
        ...
        help = "This is the address of config contract",
        display_order = 0
    )]
    ...
    #[clap(
        ...
        help = "This is the address of cluster contract",
        display_order = 0
    )]
